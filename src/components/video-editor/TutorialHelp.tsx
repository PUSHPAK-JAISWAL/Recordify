...
export function DiscordLinkButton() {
	...
	return (
		<Button
			...
			variant="ghost"
			size="sm"
			onClick={() => void openExternalLink(Recordify_DISCORD_URL, t("feedback.openFailed", "Failed to open link."))}
			...
			<DialogContent className="max-w-lg bg-[#09090b] border-white/10 [&>button]:text-slate-400 [&>button:hover]:text-white">
				...
				<div className="mt-4 space-y-4">
					<div className="rounded-xl border border-white/10 bg-white/[0.03] p-4 space-y-3">
						...
						<div className="flex items-center justify-between gap-3 rounded-lg border border-white/5 bg-white/5 px-3 py-3">
							...
							<Button
								type="button"
								variant="outline"
								onClick={() => void openExternalLink(Recordify_X_URL, t("feedback.openFailed", "Failed to open link."))}
								className="border-white/10 bg-white/5 text-slate-200 hover:bg-white/10 hover:text-white"
							>
					...
					<Button
						type="button"
						variant="outline"
						onClick={() => void openExternalLink(Recordify_ISSUES_URL, t("feedback.openFailed", "Failed to open link."))}
